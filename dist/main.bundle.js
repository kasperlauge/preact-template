...
var todolist_1 = __webpack_require__(/*! ./todo/todolist */ "./src/todo/todolist.tsx");
...
Object.defineProperty(exports, "__esModule", { value: true });
var preact_1 = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.mjs");
var todo_element_1 = __webpack_require__(/*! ./todo-element */ "./src/todo/todo-element.tsx");
var TodoList = /** @class */ (function (_super) {
    ...
    TodoList.prototype.render = function () {
        var todos = [];
        for (var _i = 0, _a = this.state.todos; _i < _a.length; _i++) {
            var todo = _a[_i];
            todos.push(preact_1.h(todo_element_1.default, { name: todo.name, done: todo.done }));
        }
        return (preact_1.h("div", null,
            preact_1.h("h1", null, "TodoList"),
            todos));
    };
    return TodoList;
}(preact_1.Component));
